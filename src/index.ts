...
export type { PrinterStatusData, PrinterCoreStatus, PrintJobStatus, TemperatureStatus, FanStatus, CanvasStatus, TrayInfo } from "./domain/entities/PrinterStatus.js";
export type { PrinterAttributes, PrinterCapabilities } from "./domain/entities/PrinterAttributes.js";
...
export type { ConnectParams, StartPrintParams, SlotMapItem, Unsubscribe } from "./domain/ports/PrinterAdapter.js";
